    ...
    public class CustomersRepository : ICustomersRepository
    {
        ...
        public Customers Get(string customerId)
        {
            using (var connection = _connectionFactory.GetConnection)
            {
                ...
                Customers customer = connection.QuerySingle<Customers>(query, parameters, commandType: CommandType.StoredProcedure);
                return customer;
            }
        }
        ...
        public async Task<Customers> GetAsync(string customerId)
        {
            using (var connection = _connectionFactory.GetConnection)
            {
                ...
                Customers customer = await connection.QuerySingleAsync<Customers>(query, parameters, commandType: CommandType.StoredProcedure);
                return customer;
            }
        }
